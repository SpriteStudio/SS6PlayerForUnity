...
//					CHANGE_TRANSFORM_SCALING = 0x00400000,
				...
				internal struct BufferParameterSprite
				{
					/* ----------------------------------------------- Variables & Properties */
					#region Variables & Properties
					/* MEMO: Common */
...
//						else
					...
					Plain_PartColor_End:;
						...
						DrawMesh.Exec(	instanceTransform, 
										instanceRoot.MaterialGet(indexCellMap, instanceRoot.DataAnimation.TableParts[idParts].OperationBlendTarget),
...
//					private readonly static Vector2 PivotTextureDefault = new Vector2(0.5f, 0.5f);
